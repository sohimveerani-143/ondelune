...
function renderFatalError(err) {
  ...
  root.innerHTML = `
    <div class="fatal-error">
      ...
      <p>If you're testing locally, run a simple server (e.g. <code style="display:inline;padding:2px 6px;">python3 -m http.server</code>) rather than opening index.html directly.</p>
